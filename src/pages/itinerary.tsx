...
// { places, description, days }
{
  ...
  const [itinarySaved, setItinarySaved] = useState(false)
    ...
    <div>
      ...
      >
        ...
        <div className=" container mx-auto mt-20 pb-20 px-5 lg:px-0">
          ...
          {!itinarySaved && <button
            className={`text-xl font-semibold ${savedItinaryId ? "bg-red-700" : "bg-primary2"
